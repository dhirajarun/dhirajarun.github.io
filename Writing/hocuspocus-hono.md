...
Hono has middleware and [helpers](https://github.com/honojs/middleware/tree/main/packages/node-ws) to work with websocket but I had to modify the code a bit to make it work with Hocuspocus.
